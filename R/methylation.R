...
##' expression for all genes within 1 Mb of the methylation site.
##'
...
##' @param gene.data A data.frame or matrix containing gene expression data. The columns of this data.frame must correspond exactly to columns of the methylation data. Row names must be array IDs.
...
##' @export
##' @author James W. MacDonald <jmacdon@u.washington.edu>
methByRegion <- function(bmpsObj, eset, fit, mart, samps, contname, longname, genes, gene.data, fitcol, cut = 0.001, dontuse = "AGA"){
...
##'
##' This function is not normally called by the end user. Instead, it is ussed by \Rfunction{methByRegion} to create
##' HTML tables with links 
##' @title 
##' @param lstitm 
##' @param dat 
##' @param prb 
...
geneByMeth <- function(tab,  genes, eset, samps, gene.data, contname, dontuse = "AGA"){
